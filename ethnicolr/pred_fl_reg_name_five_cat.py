...
class FloridaRegNameFiveCatModel(EthnicolrModelClass):
    MODELFN = "models/fl_voter_reg/lstm/fl_name_five_cat{0:s}_lstm_pt.pt"
    VOCABFN = "models/fl_voter_reg/lstm/fl_name_five_cat{0:s}_vocab_pt.csv"
    RACEFN = "models/fl_voter_reg/lstm/fl_name_five_cat{0:s}_race_pt.csv"
