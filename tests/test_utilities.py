...
class TestArgParser:
    ...
    def test_argument_parsing_with_first_name(self, temp_input_file):
        ...
        argv = [temp_input_file, '-l', 'lastname', '-f', 'firstname', '-o', 'output.csv']
    ...
    def test_missing_required_first_name_error(self, temp_input_file):
        ...
        argv = [temp_input_file, '-l', 'lastname']  # Missing -f firstname when first=True
...
class TestArgParserEdgeCases:
    ...
    def test_very_long_file_paths(self):
        ...
        try:
            argv = [temp_path, '-l', 'a' * 100, '-o', 'b' * 100]  # Long column/file names
    ...
    def test_special_characters_in_arguments(self):
        ...
        try:
            argv = [
                temp_path,
                '-l', 'surname-with-dashes_and_underscores',
                '-o', 'output-file_name.csv'
            ]
